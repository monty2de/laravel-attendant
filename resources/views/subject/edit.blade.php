                ...
                <div class="card-body">
                    <form method="POST" action="/subjects/{{$sub->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ $sub->code }}" required autocomplete="code" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="unit" type="text" class="form-control @error('unit') is-invalid @enderror" name="unit" value="{{ $sub->unit }}" required autocomplete="unit" autofocus>
